        ...
        <div className={sidebarClassNames}>
            <div className='flex h-[100%] w-full flex-col justify-start'>
                ...
                <div className='z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black'>
                    <div className='text-xl gont-bold text-gray-800 dark:text-white'>
                        EDLIST
                    </div>
                ...
                <nav className='z-10 w-full'>
                    <SidebarLink icon={Home} label='Home' href='/' icCollapsed={false} />
                    <SidebarLink icon={Briefcase} label='Timeline' href='/timeline' icCollapsed={false} />
                    <SidebarLink icon={Search} label='Search' href='/search' icCollapsed={false} />
                    <SidebarLink icon={Settings} label='Settings' href='/settings' icCollapsed={false} />
                    <SidebarLink icon={User} label='Users' href='/users' icCollapsed={false} />
                    <SidebarLink icon={Users} label='Teams' href='/teams' icCollapsed={false} />
                </nav>
                ...
                {showPriority && (
                    <>
                        <SidebarLink icon={AlertCircle} label='Urgent' href='/priority/urgent' icCollapsed={false} />
                        <SidebarLink icon={ShieldAlert} label='High' href='/priority/high' icCollapsed={false} />
                        <SidebarLink icon={AlertTriangle} label='Medium' href='/priority/medium' icCollapsed={false} />
                        <SidebarLink icon={AlertOctagon} label='Low' href='/priority/low' icCollapsed={false} />
                        <SidebarLink icon={Layers3} label='Backlog' href='/priority/backlog' icCollapsed={false} />
                    </>
                )
                }
            </div>
            <div className='z-10 mt-32 flexw w-full flex-col items-center gap-4 bg-white px-8 py-4 dark:bg-black md:hidden'>
