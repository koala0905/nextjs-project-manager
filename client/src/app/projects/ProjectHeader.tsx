        ...
        <div className='px-4 xl:px-6'>
            ...
            <div className='pb-6 pt-6 lg:pb-4 lg:pt-8'>
                <Header name='Product Design Development'
                    buttonComponent={
                        <button className='flex item-center rounded-md bg-blue-primary px-3 py-2 text-white hover:bg-blue-600'
            ...
            <div className='flex flex-wrap-reverse  gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center'>
                ...
                <div className='flex items-center gap-2'>
                    <button className='text-gray-500 hover:text-gray-600 dark:text-neutral-500 dark:hover:text-gray-300'>
                        <Filter className='h5- w-5'></Filter>
                    </button>
                    <button className='text-gray-500 hover:text-gray-600 dark:text-neutral-500 dark:hover:text-gray-300'>
                        <Share2 className='h5- w-5'></Share2>
                    </button>
                    <div className='relative'>
                        <input type='text' placeholder='Search Task' className='round-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white' />
