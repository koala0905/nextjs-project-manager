...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_authouUserId_fkey" FOREIGN KEY ("authouUserId") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
